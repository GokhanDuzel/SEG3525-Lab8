...
const PopupExample = () => (
  <Popup trigger={<Button className="bg-secondary">Buy</Button>} position="right center">
    ...
    <form onSubmit={handleSubmit}>
              ...
              <br/><Button block variant="outline-warning text-secondary" type="submit">Buy</Button>
...
<br/>
         <div className="d-flex justify-content-center">
           <h1 className="text-secondary float-none"><strong>Shop</strong></h1>
         </div>
    <div className="container d-flex justify-content-center">

    <div className="container"><br/>
      <div className="card bg-warning" style={{"textAlign":"center"}, {"width":"250px"}}>
